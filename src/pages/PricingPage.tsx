...
const PricingPage = () => {
  ...
  return (
    <div style={{ background: BG, color: TEXT, minHeight: "100vh", fontFamily: "'Inter', 'Plus Jakarta Sans', sans-serif" }}>
      ...
      <SiteNav navigate={navigate} onGetStarted={handleGetStarted} />
                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: plan.pro ? P : "rgba(255, 255, 255, 0.7)",
          ...
          <div style={{ maxWidth: 760, margin: "0 auto" }}>
            <motion.div {...fadeUp} style={{ ...glassCard, padding: "clamp(36px, 6vw, 60px)", textAlign: "center" }}>
              ...
              <button
                ...
                style={{ background: "rgba(115,49,223,0.2)", color: P_SEC, border: "1px solid rgba(115,49,223,0.4)", padding: "14px 36px", borderRadius: 9999, fontSize: 15, fontWeight: 700, cursor: "pointer", transition: "all 0.25s", display: "inline-flex", alignItems: "center", gap: 8 }}
                onMouseEnter={e => { e.currentTarget.style.background = "rgba(115,49,223,0.3)"; }}
                onMouseLeave={e => { e.currentTarget.style.background = "rgba(115,49,223,0.2)"; }}
              >
